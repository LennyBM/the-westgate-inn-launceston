              ...
              <div key={group.title} className="mb-14 last:mb-0">
                <Reveal>
                  <div className="text-center mb-8">
                    <h3 className="font-headline italic text-3xl text-ink">{group.title}</h3>
                  ...
                  {group.items.map((it, i) => (
                    <Reveal key={i}>
                      <div className="flex items-baseline gap-3 py-3 border-b border-line">
                        ...
                        {it.price && <span className="font-headline italic text-lg text-primary whitespace-nowrap">{it.price}</span>}
                      </div>
                    </Reveal>
                  ))}
                </div>
